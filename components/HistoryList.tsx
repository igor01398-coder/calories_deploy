...
import { Trash2, Clock, Flame, Edit2, X, Save, Coffee, Sun, Moon, Utensils, Star } from 'lucide-react';
...
export const HistoryList: React.FC<HistoryListProps> = ({ entries, onDelete, onUpdate, selectedDate }) => {
